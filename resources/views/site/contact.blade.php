...
<div class="mid_part inner_page contact_page">
        ...
        <div class="inner_banner" style="background: url({{asset('assets/site/assets/images/sleeping-buddha.jpg') }}); background-size: cover; background-attachment: fixed; width: 100%;"></div>
