                                    ...
                                    <div id="divgrid">
                                        <div class="item">
                                            <div class="item-inner card">
                                                ...
                                                @endif
                                                <div class="card-body">
                                                    <div class="card-meta"><i class="fa fa-clock-o">&nbsp;</i> {{ $row->created_at }}&nbsp; <i class="fa fa-user"> </i>&nbsp;{{ $row->postCategory->name}} &nbsp;<i class="fa fa-eye">&nbsp; </i>{{ $row->visit_no}} </div>
                                                    @if(isset($row->title))
                                                    @if(Route::has('site.post.show'))
                                                    <a href="{{ route('site.post.show', ['id' => $row->unique_id] )}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <i class="fa fa-clock-o">&nbsp;</i> {{ $row->created_at }}&nbsp; <i class="fa fa-user"> </i>&nbsp;{{ $row->postCategory->name }} &nbsp;<i class="fa fa-eye">&nbsp; </i>{{ $row->visit_no }}
                                                </div>
                                                <div class="col-md-3">
