            ...
            <section class="card">
                ...
                <div class="card-box">
                    ...
                    <div class=" form">
                        ...
                        dm_hinputUpdate('text','rows['.$loop->index.'][title]', "Question(<strong>$row->name</strong>)(*)", $name);
                        dm_htextareaUpdate('rows['.$loop->index.'][description]', "Answer(<strong>$row->description</strong>)(*)", $description);
                        ?>
                        @endforeach
                        <?php
