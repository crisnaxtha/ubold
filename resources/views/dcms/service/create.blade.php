            ...
            <section class="card">
                ...
                <div class="card-box">
                    ...
                    <div class=" form">
                        ...
                        dm_hinput('text','rows['.$loop->index.'][title]', "Name (<strong>$row->name</strong>)(*)", 'rows.'.$loop->index.'.title');
                        dm_hinput('text','rows['.$loop->index.'][description]', "Description (<strong>$row->name</strong>)(*)", 'rows.'.$loop->index.'.description');
                        ?>
                        @endforeach
                        <?php
